...
public class sym {
	...
	// Constants
	public static final int NUM_CONST = 16;
	...
	public static final int LPARENT = 38;
	public static final int RPARENT = 39;
	public static final int LBRACKET = 40;
	public static final int RBRACKET = 41;
	public static final int LBRACES = 42;
	public static final int RBRACES = 43;
